<header class="p-2 bg-gray-800 text-gray-100">
    
    <div class="min-h-full justify-center">
    ...
    <div class="container flex justify-between h-16 mx-auto">
        <ul class="items-stretch hidden space-x-3 lg:flex">
            ...
            <li class="flex">
                <a rel="noopener noreferrer" href="<?php echo e(route('contact.form')); ?>"
        ...
        <div class="flex items-center md:space-x-4">
            <div class="relative">
                ...
                <input type="search" name="Search" placeholder="Search..."
                    class="w-32 py-2 pl-10 text-sm rounded-md sm:w-auto focus:outline-none bg-gray-800 text-gray-100 focus:bg-gray-900">
            </div>
        </div>
...
<?php /**PATH C:\Users\BANNN\Desktop\Balong-1\resources\views/frontend/layouts/navbar.blade.php ENDPATH**/ ?>